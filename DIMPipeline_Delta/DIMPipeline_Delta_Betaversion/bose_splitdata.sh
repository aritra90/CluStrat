...
######---------------------------------------------------------
######    Input arguments
dataset=`readlink -e "/depot/pdrineas/data/DIMs/Repo/$1".bed | sed 's/\.bed//'`
######---------------------------------------------------------
...
echo `awk '{if($6==2) print $1,$2}' "/depot/pdrineas/data/DIMs/Repo/${dataset##*/}".fam > ${dataset##*/}_cases.txt`

echo `awk '{if($6==1) print $1,$2}' "/depot/pdrineas/data/DIMs/Repo/${dataset##*/}".fam > ${dataset##*/}_controls.txt`
